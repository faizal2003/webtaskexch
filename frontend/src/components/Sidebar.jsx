  ...
  return (
    <div className="sidebar">
      <div className="logo">
        ...
        />
        <div
          style={{ fontSize: "1.8rem", fontWeight: "bold", color: "#7C3AED" }}
        >
          Boost
        </div>
      </div>
      ...
      <Link
        to="/dashboard"
        className={`menu-link ${location.pathname.startsWith("/dashboard") || location.pathname === "/create" ? "active" : ""}`}
      >
      ...
      <Link
        to="/terms"
        className={`menu-link ${location.pathname === "/terms" ? "active" : ""}`}
      >
